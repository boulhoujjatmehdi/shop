						...
						<div class="header-cart header-dropdown">
							...
							<div class="header-cart-buttons">
								<div class="header-cart-wrapbtn">
									<!-- Button -->
									<a href="<?php echo url('/cart'); ?>" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
										View Cart
									</a>
								</div>
			...
			<nav class="side-menu">
				<ul class="main-menu">
					...
					<li class="item-menu-mobile">
						<a href="<?php echo url('/'); ?>">Home</a>
						<ul class="sub-menu">
							<li><a href="<?php echo url('/'); ?>">Homepage V1</a></li>
					...
					<li class="item-menu-mobile">
						<a href="<?php echo url('/cart'); ?>">Features</a>
					</li>
					...
					<li class="item-menu-mobile">
						<a href="<?php echo url('/about'); ?>">Contact</a>
					</li>
				</ul>
			</nav>
		</div>
