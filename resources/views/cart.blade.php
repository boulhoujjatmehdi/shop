					...
					<table class="table-shopping-cart">
						...
						@foreach($allcart as $item)
								...
								<tr class="table-row">
									...
									<td class="column-3">{{$item->price}} DH</td>
									<td class="column-4">
											...
											<form id="form{{$nbr}}" action="" method="POST">
													@csrf</form>
												<input type="text" name="user_id" value="{{Auth::user()->id}}" style="display: none" form="form{{$nbr}}">
												<input type="text" name="product_id" value="{{$item->id}}" style="display: none" form="form{{$nbr}}">
												<input type="text" name="from" value="cart" style="display: none" form="form{{$nbr}}">
												<input class="size2  m-text18 t-center num-product" type="number" name="quantity" value="{{$item->stock}}" form="form{{$nbr}}">
												
												<button type="submit" class="color1 flex-c-m size2 bg8 eff2" form="form{{$nbr}}">
													update
												</button>
											<form  id="formD{{$nbr}}" action="{{url('cart/')}}/{{$item->id}}" method="POST" >
													{{method_field('DELETE')}}
													@csrf</form>
													<button form="formD{{$nbr}}" type="submit" class="color1 flex-c-m size2 bg8 eff2" style="color: white ; background-color: #e3342f;">
														Delete
													</button>
									...
									<td class="column-5">{{$item->size}} Dh </td>
								</tr>
